    ...
    <body>
        ...
        <div class="tabs">
            ...
            <div class="embeded_website">
                <iframe scrolling="no" src="member-competition.php" style="width: 100%; overflow: hidden; border: 0px none; height: 900px;"></iframe>
            </div>
            
            <input type="radio" id="tab_workshop" name="tabs" checked="checked"/>
            <label for="tab_workshop">Workshop</label>
            <div class="embeded_website">
                <iframe scrolling="no" src="member-workshop.php" style="width: 100%; overflow: hidden; border: 0px none; height: 900px;"></iframe>
            </div>    

            <input type="radio" id="tab_talk" name="tabs" checked="checked"/>
            <label for="tab_talk">Talk</label>
            <div class="embeded_website">
                <iframe scrolling="no" src="member-talk.php" style="width: 100%; overflow: hidden; border: 0px none; height: 900px;"></iframe>
            </div>    
</div>  
