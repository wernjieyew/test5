...
<html>
    ...
    <?php
            ...
            $q = "SELECT * FROM event WHERE Event_type = 'Workshop'";
                    ...
                    <div class="event_row">
                        <div class="row1">
                            ...
                            <div class="content">
                                ...
                                <a href="member-workshop-register.php?id='.$row['Event_id'].'&name='.$row['Event_name'].'&type='.$row['Event_type'].'"target="_blank">JOIN</a>
