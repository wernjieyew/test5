        ...
        $student_id =$_REQUEST["student"];
            ...
            if(!empty($_POST)){
                ...
                if($r){
                    ...
                    document.location.href='member-joined-event.php'
                 </script>"; 
                }else{
                     echo"<script type='text/javascript'>
                     alert('Delete failed');
...
<html>
    ...
    <body>  
        <div class="c"> 
             ...
             <form method="post" action="delete-event-joined.php">  
                 <div class="h">  
              <h1>Delete Your information from Joined Event?</h1>
            ...
            <tr>
             ...
             <td><label for="studentid"><b>Student ID</b></label> </td>
              ...
              <input type="button" value="Cancel" onclick="location='member-joined-event.php'"/>
              </div>
        </form>
       </div> 
    </body>
